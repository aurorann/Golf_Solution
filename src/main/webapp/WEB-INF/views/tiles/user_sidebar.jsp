	...
	<div class="sidebar-content sidebar-small ">
		...
		<div class="sidebar-section">
			<ul class="nav nav-sidebar" data-nav-type="accordion">
				...
				<a href="/user/user_management" class="nav-link"> <i class="icon-users2"></i> <span>회원 관리 </span></a> 
				</sec:authorize>
				<a href="/user/user_info" class="nav-link"> <i class="icon-vcard"></i> <span> 내 정보 </span>
				</a></li>
				<!-- /main -->
			</ul>
		</div>
