...
<div class="navbar navbar-expand-lg navbar-light navbar-static">
	...
	<ul class="navbar-nav flex-row order-1 order-lg-2 flex-1 flex-lg-0 justify-content-end align-items-center">
		<li class="nav-item"><a href="#" class="navbar-nav-link navbar-nav-link-toggler"> <i class="fas fa-bell"></i>
		...
		<li class="nav-item nav-item-dropdown-lg dropdown dropdown-user h-100"><a href="#"
			...
			data-toggle="dropdown"> <img src="/resources/assets/img/user.png" class="rounded-pill mr-lg-2" height="34" alt="">
